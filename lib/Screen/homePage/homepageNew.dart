...
import '/Screen/homePage/widgets/MostLikeSection.dart';
import '/Screen/homePage/widgets/hideAppBarBottom.dart';
import '/Screen/homePage/widgets/homePageDialog.dart';
import '/Screen/homePage/widgets/horizontalCategoryList.dart';
import '/Screen/homePage/widgets/section.dart';
import '/Screen/homePage/widgets/slider.dart';
    ...
    Future.delayed(Duration(seconds: 6)).then(
      (value) {
        if (homePageSingleSellerMessage) {
          ...
          showOverlay(
           getTranslated(context, 'One of the product is out of stock, We are not able To Add In Cart')!,
            context,
          );
        }
      },
