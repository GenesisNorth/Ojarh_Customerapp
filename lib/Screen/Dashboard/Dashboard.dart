...
import '/Screen/Profile/MyProfile.dart';
import '/Screen/ExploreSection/explore.dart';
...
import '../Test/Animation.dart';
import '../Test/Widget/ListTile1.dart';
...
class _DashboardPageState extends State<Dashboard>
  ...
  _getAppBar() {
    ...
    final appBar = AppBar(
      ...
      title: _selBottom == 0
          ? SvgPicture.asset(
              DesignConfiguration.setPngPath('titleicon'),
              height: 40,
            )
          : Text(
              title!,
